...
class GlobalSet extends Page implements HasForms
{
    ...
    public function mount(): void
    {
        ...
        $this->data = [
            ...
            'home_meta_description' => $settings->home_meta_description ?? ['en' => 'Welcome to our sites home page', 'uk' => 'Ласкаво просимо на головну сторінку нашого сайту'],
            ...
            'contacts_meta_description' => $settings->contacts_meta_description ?? ['en' => 'Get in touch with us', 'uk' => 'Звяжіться з нами'],
