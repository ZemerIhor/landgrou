...
return new class extends SettingsMigration
{
    public function up(): void
    {
        ...
        $this->migrator->add('about_us.hero_description', ['en' => 'LLC "Land Grou" is a leading Ukrainian enterprise in peat extraction and processing, located in Rivne Oblast. We are the successor to the regions peat industry history, which began in 1953. Our company plays a key role in ensuring Ukraines energy security by offering high-quality peat briquettes as an alternative to traditional fuels.', 'uk' => 'ТОВ «Ленд Гроу» — провідне українське підприємство з видобування та переробки торфу, розташоване в Рівненській області. Ми є правонаступником багаторічної історії торфяної промисловості регіону, що бере свій початок з 1953 року. Наше підприємство відіграє ключову роль у забезпеченні енергетичної безпеки України, пропонуючи високоякісні торфяні брикети як альтернативу традиційним видам палива.']);
        ...
        $this->migrator->add('about_us.about_description', [
            'en' => [
                ...
                'We are proud of our history, experience, and contribution to Ukraines energy independence. Our mission is to provide consumers with high-quality, affordable, and environmentally safe fuel, promoting sustainable development and environmental preservation.',
            ],
            'uk' => [
                ...
                'Наша команда складається з висококваліфікованих фахівців, багато з яких мають понад 20 років досвіду в торфяній галузі. Ми постійно впроваджуємо сучасні технології та інноваційні рішення, що дозволяє нам підтримувати високі стандарти якості та ефективності виробництва.',
                ...
                'ТОВ «Ленд Гроу» також активно розвиває експортний напрямок, постачаючи фрезерний торф та торфяні брикети зарубіжним партнерам. Ми прагнемо до розширення географії поставок та зміцнення позицій на міжнародному ринку, пропонуючи надійні та екологічно чисті паливні рішення.',
