<div class="flex flex-col  mx-auto w-full max-md:max-w-full md:px-12 px-4 py-4 container blog-page">
            ...
            <div class="flex flex-wrap gap-2 items-center w-full">
                    <a href="{{ route('blog.post', $post->slug) }}"
                        ...
                        <div class="z-0 p-4 w-full font-semibold">
                            ...
                            <svg class="flex absolute top-0 right-0 z-0 gap-2.5 justify-center items-center w-14 h-14 min-h-14 hover:bg-black hover:bg-opacity-10 focus:outline-none focus:ring-2 focus:ring-green-600 focus:ring-offset-2 rounded" width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
