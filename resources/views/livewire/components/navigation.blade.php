    ...
    <div class="main-container nav-header flex relative justify-between items-center py-2 px-4 w-full h-auto container mx-auto">
        ...
        <div class="flex gap-3 items-center relative" x-data="{ mobileMenu: false, languageMenu: false }">
            ...
            <div class="flex gap-3 items-center">
                <a href="{{ isset($headerSettings->instagram_url[$locale]) ? $headerSettings->instagram_url[$locale] : 'https://instagram.com' }}" class="social-link" aria-label="Подписаться в Instagram">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="social-icon hover:stroke-green-600">
                ...
                <a href="{{ isset($headerSettings->facebook_url[$locale]) ? $headerSettings->facebook_url[$locale] : 'https://facebook.com' }}" class="social-link" aria-label="Подписаться в Facebook">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="social-icon hover:stroke-green-600">
                ...
                <a href="{{ isset($headerSettings->telegram_url[$locale]) ? $headerSettings->telegram_url[$locale] : 'https://telegram.com' }}" class="social-link" aria-label="Подписаться в Telegram">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="social-icon hover:stroke-green-600">
                ...
                <nav class="flex flex-col items-center gap-4 py-4 text-sm font-semibold text-zinc-800" role="navigation" aria-label="Мобильная навигация">
                    ...
                    <div class="relative w-full px-4">
                        <button
                            ...
                            class="flex items-center justify-between w-full px-4 py-2 text-sm font-semibold text-zinc-800 hover:text-green-600 focus:outline-none focus:ring-2 focus:ring-green-600"
                            aria-label="{{ __('messages.language.current') }}"
