    ...
    <div class="main-container nav-header flex relative justify-between items-center py-2 px-4 sm:px-6 w-full h-auto container mx-auto">
        ...
        <div class="flex gap-2 sm:gap-3 items-center relative" x-data="{ mobileMenu: false, languageMenu: false }">
            ...
            <div class="flex gap-2 sm:gap-3 items-center">
                <a href="{{ isset($headerSettings->instagram_url[$locale]) ? $headerSettings->instagram_url[$locale] : 'https://instagram.com' }}" class="social-link" aria-label="Follow on Instagram">
                ...
                <a href="{{ isset($headerSettings->facebook_url[$locale]) ? $headerSettings->facebook_url[$locale] : 'https://facebook.com' }}" class="social-link" aria-label="Follow on Facebook">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="social-icon hover:stroke-green-600">
                ...
                <a href="{{ isset($headerSettings->telegram_url[$locale]) ? $headerSettings->telegram_url[$locale] : 'https://telegram.com' }}" class="social-link" aria-label="Follow on Telegram">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="social-icon hover:stroke-green-600">
