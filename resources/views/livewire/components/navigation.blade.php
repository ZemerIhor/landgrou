...
<div x-data="{ isScrolled: false, mobileMenu: false, languageMenu: false, headerHeight: 0 }"
     x-init="headerHeight = document.getElementById('header').offsetHeight; $watch('isScrolled', () => headerHeight = document.getElementById('header').offsetHeight)"
     @scroll.window="isScrolled = (window.scrollY > 0)"
     @resize.window="headerHeight = document.getElementById('header').offsetHeight">
    <header id="header"
