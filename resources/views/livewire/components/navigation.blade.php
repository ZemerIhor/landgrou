    ...
    <div class="main-container flex relative justify-between items-center py-2 px-4 w-full h-auto container mx-auto">
        ...
        <div class="flex gap-3 items-center relative" x-data="{ mobileMenu: false, showContactForm: false, languageMenu: false }">
            ...
            <div class="flex gap-3 items-center">
                <a href="https://instagram.com" class="social-link" aria-label="Подписаться в Instagram">
                ...
                <a href="https://facebook.com" class="social-link" aria-label="Подписаться в Facebook">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="social-icon hover:stroke-green-600">
                ...
                <a href="https://telegram.com" class="social-link" aria-label="Подписаться в Telegram">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="social-icon hover:stroke-green-600">
