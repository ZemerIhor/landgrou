...
<div x-data="{ isScrolled: false }" @scroll.window="isScrolled = (window.scrollY > 0)">
    <header class="shadow-xl h-[56px] flex items-center bg-white top-0 left-0 right-0 z-50 transition-all duration-300"
        ...
        <div class="main-container nav-header flex relative justify-between items-center w-full h-auto container mx-auto">
            ...
            <!-- Desktop Menu -->
            <div class="desktop-menu flex sm:hidden ">
                @if(app()->getLocale() === 'en')
            ...
            <div class="flex gap-2 sm:gap-3 items-center relative" x-data="{ mobileMenu: false, languageMenu: false }">
                ...
                <div class="flex gap-2 sm:gap-3 items-center">
                    <a href="{{ isset($headerSettings->instagram_url[$locale]) ? $headerSettings->instagram_url[$locale] : 'https://instagram.com' }}" class="social-link" aria-label="{{ __('messages.social.instagram') }}">
                    ...
                    <a href="{{ isset($headerSettings->facebook_url[$locale]) ? $headerSettings->facebook_url[$locale] : 'https://facebook.com' }}" class="social-link" aria-label="{{ __('messages.social.facebook') }}">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="social-icon hover:stroke-green-600">
                    ...
                    <a href="{{ isset($headerSettings->telegram_url[$locale]) ? $headerSettings->telegram_url[$locale] : 'https://telegram.com' }}" class="social-link" aria-label="{{ __('messages.social.telegram') }}">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="social-icon hover:stroke-green-600">
