<section class="flex container mx-auto flex-col self-stretch px-5 py-20 max-md:px-5" role="main" aria-labelledby="blog-heading">
    ...
    <div class="flex flex-wrap gap-2 items-center mt-5 w-full min-h-[307px] max-md:max-w-full" role="region" aria-label="{{ __('messages.blog.articles') }}">
        @forelse ($blogPosts as $post)
            <article class="overflow-hidden relative flex-1 shrink self-stretch my-auto rounded-3xl basis-0 bg-neutral-200 min-w-60" tabindex="0" role="article">
                ...
                <div class="z-0 p-4 w-full font-semibold">
                    ...
                    <p class="text-sm text-zinc-600 mt-2វ2">
    ...
    @if ($blogPosts->count() > 0)
        <a
            ...
            aria-label="{{ __('messages.blog.more_button_aria_label') }}"
        >
