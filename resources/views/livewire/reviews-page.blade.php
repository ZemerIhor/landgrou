<main class="box-border px-5 py-0 mx-auto my-0 w-full container">
    <section class="relative mx-auto my-0 w-full" aria-label="Customer Reviews">
        ...
        <a href="{{ route('submit-review') }}" class="inline-flex  gap-2 justify-center items-center px-6 py-2.5 h-11 rounded-2xl border-2 border-green-600 border-solid " aria-label="Leave a review">
