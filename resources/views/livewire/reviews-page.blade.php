<main class="box-border px-5 py-0 mx-auto my-0 w-full max-w-[1180px]">
    <section class="relative mx-auto my-0 w-full h-[1404px] max-w-[1180px]" aria-label="Customer Reviews">
        <div class="absolute top-0 left-0 w-full h-[1340px] max-w-[1180px]">
            <div class="flex absolute top-0 left-2/4 flex-col gap-2 justify-center items-start w-full -translate-x-2/4 h-[1240px] max-w-[782px]">
        ...
        <a href="{{ route('submit-review') }}" class="inline-flex absolute left-2/4 gap-2 justify-center items-center px-6 py-2.5 h-11 rounded-2xl border-2 border-green-600 border-solid -translate-x-2/4 min-h-11 top-[1360px] w-[226px]" aria-label="Leave a review">
