...
<main class=" container mx-auto box-border px-[16px] sm:px-[28px] md:px-[50px] py-0 mx-auto my-0 mb-[100px] w-full ">
    ...
    <section class="relative flex flex-col justify-center items-center mx-auto my-0 w-full" aria-label="Customer Reviews">
        ...
        <a href="{{ route('submit-review') }}" class="mt-4 inline-flex  gap-2 justify-center items-center px-6 py-2.5 h-11 rounded-2xl border-2 border-green-600 border-solid " aria-label="{{ __('messages.reviews.leave') }">
            <span class="relative text-base font-bold leading-6 text-green-600">{{ __('messages.reviews.leave') }}</span>
