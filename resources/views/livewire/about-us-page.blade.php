    ...
    <div class="top-section">
        <header class="font-semibold">
            <div class="flex relative flex-col items-center px-12 pt-14 pb-20 w-full min-h-[780px] max-md:px-5 max-md:max-w-full">
                <!-- Фоновое изображение -->
                <img
                    src="{{ isset($settings->hero_background_image) && Storage::disk('public')->exists($settings->hero_background_image) ? Storage::url($settings->hero_background_image) : asset('images/fallback-hero.jpg') }}"
                    alt="{{ $settings->hero_background_image_alt ?? __('messages.about_us.hero_background_image_alt') }}"
                ...
                <div class="container mx-auto px-2">
                    ...
                    <div class="relative mx-auto mt-40 max-w-full font-bold text-white w-[568px] max-md:mt-10">
                        <div class="flex flex-col w-full max-md:max-w-full">
                            <!-- Логотип -->
                            <img
                                src="{{ isset($settings->hero_logo) && Storage::disk('public')->exists($settings->hero_logo) ? Storage::url($settings->hero_logo) : asset('images/fallback-logo.png') }}"
                                alt="{{ $settings->hero_logo_alt ?? __('messages.about_us.hero_logo_alt') }}"
                ...
                <div class="flex container mx-auto px-2 overflow-hidden flex-col justify-center py-10 w-full max-w-screen-xl text-center">
                    ...
                    <div class="flex flex-wrap gap-2 w-full max-md:max-w-full">
                        ...
                        @foreach($advantages as $index => $advantage)
                            ...
                            @if (isset($advantage_images[$index]))
                                <img
                                    ...
                                    alt="{{ $advantage_images[$index]['alt'] ?? '' }}"
