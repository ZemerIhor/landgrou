    ...
    <header class="flex relative flex-col gap-4 items-start self-stretch">
        ...
        <div class="flex relative gap-28 items-start self-stretch max-md:flex-col max-md:gap-8">
            <section class="flex relative flex-col items-start w-[487px] max-md:w-full"
                ...
                <div class="swiper product-gallery w-full rounded-3xl" wire:ignore.self>
                ...
                <div class="swiper-pagination" style="position: absolute; bottom: -50px; left: 0; width: 136px;"></div>
            ...
            <script>
                document.addEventListener('DOMContentLoaded', function () {
                    ...
                    function initSwiper() {
                        ...
                        try {
                            ...
                            if (!document.querySelector('.swiper-pagination')) {
                                console.warn('Элемент пагинации не найден, создаем новый');
                                const paginationEl = document.createElement('div');
                                paginationEl.className = 'swiper-pagination';
                                paginationEl.style.position = 'absolute';
                                paginationEl.style.bottom = '-50px';
                                paginationEl.style.left = '0';
                                paginationEl.style.width = '136px';
                                swiperContainer.after(paginationEl);
                            }

                            // Уничтожаем предыдущий экземпляр Swiper
                            if (swiperInstance) {
                                swiperInstance.destroy(true, true);
                                console.log('Предыдущий Swiper уничтожен');
                            }
                            ...
                            swiperInstance = new window.Swiper(swiperContainer, {
                                ...
                                on: {
                                    ...
                                    paginationRender: function (swiper, paginationEl) {
                                        console.log('Пагинация отрендерена:', paginationEl, 'Буллеты:', paginationEl.querySelectorAll('.swiper-pagination-bullet').length);
                                    },
                                    paginationUpdate: function (swiper, paginationEl) {
                                        console.log('Пагинация обновлена:', paginationEl, 'Буллеты:', paginationEl.querySelectorAll('.swiper-pagination-bullet').length);
                                    },
                                },
                            });
                    ...
                    document.addEventListener('livewire:navigated', function () {
                        console.log('Переинициализация Swiper из-за Livewire:navigated');
                        initSwiper();
                    });

                    Livewire.on('update', () => {
                        console.log('Livewire обновление, переинициализация Swiper');
                        initSwiper();
                    });
                });
            </script>
