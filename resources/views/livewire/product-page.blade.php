        ...
        <div class="flex relative gap-28 items-start self-stretch max-md:flex-col max-md:gap-8">
            <section class="flex relative flex-col items-start self-stretch w-[487px] max-md:w-full"
                ...
                <div class="swiper product-gallery w-full rounded-3xl" wire:ignore>
                    ...
                    <div class="swiper-pagination" style="position: absolute; bottom: 27px; left: 176px; width: 136px;"></div>
                    <div class="swiper-button-prev" style="left: 413px; bottom: 0; width: 26px; height: 56px;">
                    ...
                    <div class="swiper-button-next" style="left: 449px; bottom: 0; width: 26px; height: 56px;">
