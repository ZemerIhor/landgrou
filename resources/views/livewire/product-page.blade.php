    ...
    <header class="flex relative flex-col gap-4 items-start self-stretch">
        ...
        <div class="flex relative gap-28 items-start self-stretch max-md:flex-col max-md:gap-8">
            <section class="flex relative flex-col items-start w-[487px] max-md:w-full"
                ...
                <div class="swiper-pagination" style="position: absolute; bottom: -50px; left: 0; width: 136px; text-align: left;"></div>
                <div class="swiper-button-prev" style="left: 413px; bottom: -50px; width: 26px; height: 56px;">
                    <svg width="41" height="42" viewBox="0 0 41 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M11.0777 15.4464L11.173 30.8638L30.6581 11.1361L22.0416 19.86C18.0472 23.904 11.1561 21.13 11.0777 15.4464Z" fill="#228F5D"/>
                        <path d="M11.173 30.8638L21.4513 30.8002L26.5905 30.7684C20.9036 30.783 18.0273 23.9242 22.0236 19.8781L30.6581 11.1361L11.173 30.8638Z" fill="#228F5D"/>
                            ...
                            swiperInstance = new window.Swiper(swiperContainer, {
                                ...
                                pagination: {
                                    ...
                                    renderBullet: function (index, className) {
                                        return `<span class="${className}" style="width: 10px; height: 10px; background: #228F5D; opacity: ${className.includes('active') ? 1 : 0.3}; margin: 0 4px;"></span>`;
                                    }
                                },
                                navigation: {
                                ...
                                on: {
                                    ...
                                    slideChange: function () {
                                        ...
                                        this.pagination.update(); // Явное обновление пагинации
                                    },
