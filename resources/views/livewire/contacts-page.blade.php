...
<div class="mx-auto px-12 container py-4">
    <!-- Breadcrumbs -->
    <livewire:components.breadcrumbs :currentPage="__('messages.contacts.title')" :items="[]" />
        ...
        <article class="contacts-container contact-section">
            <section>
                ...
                <address class="contact-text mt-4 not-italic">
                    ...
                    @endphp
                    {!! nl2br(e($address)) !!}<br>
                    E-Mail: <a href="mailto:{{ $settings->main_email }}"
                        class="text-green-600 hover:text-green-700 focus:text-green-700 focus:outline-none focus:ring-2 focus:ring-green-600 focus:ring-offset-2 rounded">
                        {{ $settings->main_email }}
                    </a>
                </address>
            </section>
                ...
                <div class="contact-text mt-4">
                    @foreach ($settings->sales_phones as $phone)
                        ...
                        <a href="tel:{{ $phoneNumber }}"
                            class="block text-green-600 hover:text-green-700 focus:text-green-700 focus:outline-none focus:ring-2 focus:ring-green-600 focus:ring-offset-2 rounded">
                            {{ $phoneNumber }}
                        </a>
                    @endforeach
                    E-Mail: <a href="mailto:{{ $settings->sales_email }}"
                        class="text-green-600 hover:text-green-700 focus:text-green-700 focus:outline-none focus:ring-2 focus:ring-green-600 focus:ring-offset-2 rounded">
        ...
        <article class="contacts-container contact-section contact-section-alt mt-2">
            <section>
                ...
                <div class="contact-text mt-4">
                    ...
                    @endphp
                    <a href="tel:{{ $settings->export_phone }}"
                        class="text-green-600 hover:text-green-700 focus:text-green-700 focus:outline-none focus:ring-2 focus:ring-green-600 focus:ring-offset-2 rounded">
                        {{ $settings->export_phone }}
                    </a> {{ e($contact) }}<br>
                    E-Mail: <a href="mailto:{{ $settings->export_email }}"
                        class="text-green-600 hover:text-green-700 focus:text-green-700 focus:outline-none focus:ring-2 focus:ring-green-600 focus:ring-offset-2 rounded">
            ...
            <section>
                ...
                <div class="contact-text mt-4">
                    @foreach ($settings->additional_emails as $key => $email)
                        {{ __('messages.contacts.' . $key, [], app()->getLocale()) ?: $key }}: <a href="mailto:{{ $email }}"
                            class="text-green-600 hover:text-green-700 focus:text-green-700 focus:outline-none focus:ring-2 focus:ring-green-600 focus:ring-offset-2 rounded">
                            {{ $email }}
                        </a><br>
                    @endforeach
