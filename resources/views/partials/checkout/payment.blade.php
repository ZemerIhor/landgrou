<div class="bg-white border border-gray-100 rounded-xl">
    <div class="flex items-center h-16 px-6 border-b border-gray-100">
        <h3 class="text-lg font-medium">Оплата</h3>
    </div>
    ...
    @if ($currentStep >= $steps['payment'])
        <div class="p-6 space-y-4">
            <div class="flex gap-4">
                ...
                <button @class([
                    'px-5 py-2 text-sm border font-medium rounded-lg',
                    'text-green-700 border-green-600 bg-green-50' => $paymentType === 'cash-on-delivery',
                    'text-gray-500 hover:text-gray-700' => $paymentType !== 'cash-on-delivery',
                ])
                        type="button"
            ...
            @if ($paymentType == 'cash-on-delivery')
                <form wire:submit="checkout">
                    <div class="p-4 text-sm text-center text-blue-700 rounded-lg bg-blue-50">
                        Оплата при отриманні, дані картки не потрібні.
                    </div>
