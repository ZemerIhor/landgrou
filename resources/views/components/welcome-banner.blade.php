<div class="relative mt-5 w-full container mx-auto overflow-hidden rounded-2xl" aria-label="Hero Banner">
                ...
                <div class="min-w-full flex items-center justify-center bg-black bg-cover bg-center"
                    ...
                    <div class="text-center text-white p-8">
                        <div class="flex justify-center mb-4">
                            <!-- SVG icon, оставим без изменений -->
    ...
    <!-- Navigation Arrows -->
    @if (!empty($settings->hero_slides) && is_array($settings->hero_slides) && count($settings->hero_slides) > 0)
...
<script>
    ...
    function updateSlider() {
        if (slides.length === 0) return;  // Защита от пустого слайдера
