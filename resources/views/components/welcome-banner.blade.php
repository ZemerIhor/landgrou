<div class="relative mt-5 w-full mx-auto overflow-hidden home-slider-main" aria-label="{{ __('messages.hero.aria_label') }}">
    <div class="relative mx-auto opacity-0 invisible transition-opacity duration-300" style="width: 90%" id="slider-wrap">
                        ...
                        <div class="text-center text-white p-8">
                            <div class="flex justify-center mb-4">
                                <svg width="30" height="41" viewBox="0 0 30 41" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M17.1926 21.8202C17.1926 23.4879 16.4119 25.2226 15.3614 26.4111C13.9543 28.0212 12.3255 29.1043 10.0799 29.1043C6.06099 29.1043 3.71902 25.8648 3.05401 22.5199C2.60103 20.4113 2.90944 19.9896 2.81306 18.7628C2.78415 18.5328 2.78415 18.437 2.60103 18.3794C2.57212 18.3794 2.57212 18.3603 2.57212 18.3699C2.57212 18.3794 2.5432 18.3699 2.5432 18.3699C2.45646 18.3699 2.5432 18.3411 2.45646 18.3794C2.18661 18.4945 1.79146 19 GrandTotal: 29
        ...
        @if (!empty($heroSlides) && is_array($heroSlides) && count($heroSlides) > 1)
            <button class="absolute top-1/2 left-4 transform -translate-y-1/2 rounded-full p-2"
                    onclick="moveSlide(-1)">
            ...
            <button class="absolute top-1/2 right-4 transform -translate-y-1/2 rounded-full p-2"
                    onclick="moveSlide(1)">
                <svg width="15" height="46" viewBox="0 0 15 46" fill="none" xmlns="http://www.w3.org/2000/svg">
